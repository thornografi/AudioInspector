...
`scripts/modules/encoding-ui.js`'deki `ENCODER_DETECTORS` array'inde ScriptProcessor en sonda. **Tasarım gereği:**
...
```javascript
// scripts/modules/encoding-ui.js - Pattern → UI mapping
